...
ctld.saveFileName = 'HideNSeek_CTLD_Spawned_Save.lua'
ctld.saveStaticFileName = 'HideNSeek_CTLD_Static_Save.lua'
if lfs then 
...
ctld.pickupZones = {
    { "Warsaw-PickupZone-1", "blue", -1, "yes", 0 },
...
ctld.spawnableCrates = {
    ...
    ["AA long range"] = {
        ...
        { weight = 595, desc = "Early Warning Radar", unit = "1L13 EWR" }, -- cant be used by BLUE coalition
    },
}
